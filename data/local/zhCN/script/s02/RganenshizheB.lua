...
local function OnAcceptQuestTalk(id,step)--Если отменить задание, можно принять его заново вручную.
	if( id == 30884)then
  	--  Quest.CloseNPCTalk();
		Quest.AcceptQuestTalk(30884,"<font=Dragon Font,0,19,20><color=0xfffcf157> Посланник Благодарности:<color=0xffffffff>\\n Сейчас время, когда можно второй раз получить у меня опыт, поторопись. После 21:10 можно будет получить его еще раз!");
	end
end
